...
#define MOTOR_FR 100 // <- geovas edition
#define MOTOR_FL 100
#define MOTOR_RR 100
#define MOTOR_RL 100
...
//#define dualMPU           // MPU3050 gyro and MPU6050 acc
...
//#define MMGYROVECTORLENGHT 15          // Lenght of Moving Average Vector
...
#define VBATSCALE     114 // change this value if readed Battery voltage is different than real voltage
#define VBATLEVEL1_3S 32  // 4,2V
#define VBATLEVEL2_3S 28  // 3,7V
#define VBATLEVEL3_3S 26  // 3.4V
#define NO_VBAT       8   // Avoid beeping without any battery
...
#define ACC_ORIENTATION(X, Y, Z)  {accADC[ROLL]  = -Y; accADC[PITCH] =  X; accADC[YAW]  =  Z;}    // 6050 acc
//#define GYRO_ORIENTATION(X, Y, Z) {gyroADC[ROLL] =  X; gyroADC[PITCH] = -Y; gyroADC[YAW] = -Z;} // 6050 gyro
#define GYRO_ORIENTATION(X, Y, Z) {gyroADC[ROLL] =  Y; gyroADC[PITCH] = -X; gyroADC[YAW] = -Z;}   // 3050 gyro
