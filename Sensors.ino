...
#if !defined(MPU3050_ADDRESS)         // <- geovas edition
...
//MPU3050 Gyro LPF setting <- geovas edition
...
#if not defined(dualMPU) //  <- geovas edition (strat)
void Gyro_init() {
  TWBR = ((F_CPU  / 400000L) - 16) / 2; // change the I2C clock rate to 400kHz
...
// ************************************************************************************************************
// I2C Gyroscope MPU3050 <- geovas edition
// ************************************************************************************************************
#if defined(MPU3050)
void Gyro_init() {
  TWBR = ((F_CPU / 400000L) - 16) / 2; // change the I2C clock rate to 400kHz
